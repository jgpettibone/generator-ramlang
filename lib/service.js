 ...
 */
module.exports.generate = function(moduleName, providerName, ramlResourceObj, withModule) {
  ...
  ramlResourceObj.methods = methods.generate(ramlResourceObj, providerName);
