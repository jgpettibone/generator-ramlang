...
var isCollection = function(ramlResource) {
  ...
  console.log('LOOK HERE ramlResource: ', ramlResource, ' & ramlResource.uriParameters: ', ramlResource.uriParameters, ' & ramlResource.relativeUri: ', ramlResource.relativeUri);
